  ...
  export const skills = [
    ...
    export const experiences = [
      ...
      // },
      {
        ...
        company: "Tamil Nadu Sill Development Corpration.",
        date: "Feb 2023 - April 2023",
        desc: "Worked with teams of talented software engineers to define, build and maintain cloud infrastructure. Understood client needs and objectives by conducting proactive customer and data analysis. Partnered with infrastructure teams on evaluation and feasibility assessments of new systems and technologies..",
        skills: [
          "Docker",
          "Terraform",
          "AWS",
      ...
      },
      {
        ...
        date: "Aug - Sep 2022",
        desc: "Enhanced user experiences on Three Baboons Technology PSG & Hybrid, Portals by resolving bugs & reduced load time by 40%. Built Neurobit Analytics portal using React Js with seamless interaction of REST APIs using AXIOS optimized with React Query. Refactored previous code to TypeScript, updated with new dependency and integrated Vite with Jest for Unit Testing.",
        skills: [
          // "ReactJS",
          // "NodeJs",
          // "Material UI",
